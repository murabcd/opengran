import {
  twMerge
} from "./chunk-FRSWWLSN.js";
import {
  clsx
} from "./chunk-6IKGHPRX.js";
import {
  require_jsx_runtime
} from "./chunk-BJYKQA2Y.js";
import {
  require_react_dom
...
// ../../node_modules/.bun/streamdown@2.5.0+bf16f8eded5e12ee/node_modules/streamdown/dist/chunk-BO2N2NFS.js
...
// ../../node_modules/.bun/rehype-harden@1.1.8/node_modules/rehype-harden/dist/index.js
var BlockPolicy = {
  indicator: "indicator",
  textOnly: "text-only",
  remove: "remove"
...
// ../../node_modules/.bun/hast-util-parse-selector@4.0.0/node_modules/hast-util-parse-selector/lib/index.js
var search = /[#.]/g;
...
// ../../node_modules/.bun/hastscript@9.0.1/node_modules/hastscript/lib/create-h.js
function createH(schema, defaultTagName, caseSensitive) {
  const adjust = caseSensitive ? createAdjustMap(caseSensitive) : void 0;
  function h3(selector, properties2, ...children2) {
    let node2;
...
// ../../node_modules/.bun/hastscript@9.0.1/node_modules/hastscript/lib/svg-case-sensitive-tag-names.js
...
// ../../node_modules/.bun/hastscript@9.0.1/node_modules/hastscript/lib/index.js
var h = createH(html2, "div");
var s = createH(svg2, "g", svgCaseSensitiveTagNames);

// ../../node_modules/.bun/vfile-location@5.0.3/node_modules/vfile-location/lib/index.js
...
// ../../node_modules/.bun/web-namespaces@2.0.1/node_modules/web-namespaces/index.js
var webNamespaces = {
...
// ../../node_modules/.bun/hast-util-from-parse5@8.0.3/node_modules/hast-util-from-parse5/lib/index.js
...
function zwitch(key, options) {
  ...
  function one5(value, ...parameters) {
    let fn2 = one5.invalid;
    const handlers2 = one5.handlers;
    if (value && own2.call(value, key)) {
      const id = String(value[key]);
      fn2 = own2.call(handlers2, id) ? handlers2[id] : one5.unknown;
    }
    if (fn2) {
...
// ../../node_modules/.bun/hast-util-to-parse5@8.0.1/node_modules/hast-util-to-parse5/lib/index.js
var emptyOptions = {};
...
function element2(node2, schema) {
  ...
  if (node2.properties) {
    for (prop in node2.properties) {
      if (prop !== "children" && own3.call(node2.properties, prop)) {
...
// ../../node_modules/.bun/parse5@7.3.0/node_modules/parse5/dist/common/unicode.js
...
// ../../node_modules/.bun/parse5@7.3.0/node_modules/parse5/dist/common/error-codes.js
var ERR;
(function(ERR2) {
...
// ../../node_modules/.bun/parse5@7.3.0/node_modules/parse5/dist/tokenizer/preprocessor.js
...
// ../../node_modules/.bun/parse5@7.3.0/node_modules/parse5/dist/common/token.js
var token_exports = {};
...
// ../../node_modules/.bun/entities@6.0.1/node_modules/entities/dist/esm/generated/decode-data-xml.js
...
// ../../node_modules/.bun/parse5@7.3.0/node_modules/parse5/dist/common/html.js
var html_exports = {};
...
// ../../node_modules/.bun/parse5@7.3.0/node_modules/parse5/dist/tokenizer/index.js
var State;
(function(State2) {
...
// ../../node_modules/.bun/parse5@7.3.0/node_modules/parse5/dist/parser/open-element-stack.js
...
// ../../node_modules/.bun/parse5@7.3.0/node_modules/parse5/dist/parser/formatting-element-list.js
...
// ../../node_modules/.bun/parse5@7.3.0/node_modules/parse5/dist/tree-adapters/default.js
...
// ../../node_modules/.bun/parse5@7.3.0/node_modules/parse5/dist/common/doctype.js
...
// ../../node_modules/.bun/parse5@7.3.0/node_modules/parse5/dist/common/foreign-content.js
var MIME_TYPES = {
  TEXT_HTML: "text/html",
...
// ../../node_modules/.bun/parse5@7.3.0/node_modules/parse5/dist/parser/index.js
...
// ../../node_modules/.bun/entities@6.0.1/node_modules/entities/dist/esm/escape.js
...
// ../../node_modules/.bun/parse5@7.3.0/node_modules/parse5/dist/serializer/index.js
...
// ../../node_modules/.bun/hast-util-raw@9.1.0/node_modules/hast-util-raw/lib/index.js
...
// ../../node_modules/.bun/rehype-raw@7.0.0/node_modules/rehype-raw/lib/index.js
...
// ../../node_modules/.bun/hast-util-sanitize@5.0.2/node_modules/hast-util-sanitize/lib/schema.js
...
// ../../node_modules/.bun/hast-util-sanitize@5.0.2/node_modules/hast-util-sanitize/lib/index.js
...
function element4(state, unsafe2) {
  ...
  if (name2 && name2 !== "*" && (!state.schema.tagNames || state.schema.tagNames.includes(name2))) {
    safeElement = true;
    if (state.schema.ancestors && own4.call(state.schema.ancestors, name2)) {
...
function properties(state, properties2) {
  ...
  const specific = attributes && own4.call(attributes, tagName) ? attributes[tagName] : void 0;
  const defaults = attributes && own4.call(attributes, "*") ? attributes["*"] : void 0;
  const properties_ = (
  ...
  if (required && own4.call(required, tagName)) {
    const properties3 = required[tagName];
    for (key in properties3) {
      if (own4.call(properties3, key) && !own4.call(result, key)) {
...
function safeProtocol(state, key, value) {
  const protocols = state.schema.protocols && own4.call(state.schema.protocols, key) ? state.schema.protocols[key] : void 0;
...
// ../../node_modules/.bun/rehype-sanitize@6.0.0/node_modules/rehype-sanitize/lib/index.js
...
function name(name2, options) {
  ...
  const re4 = settings.jsx ? nameReJsx : nameRe;
  return re4.test(name2);
}
...
function findComponentFromName(state, name2, allowExpression) {
  ...
  if (result.type === "Literal") {
    ...
    return own7.call(state.components, name3) ? state.components[name3] : name3;
  }
  if (state.evaluater) {
...
var Processor = class _Processor extends CallableInstance {
  ...
  data(key, value) {
    if (typeof key === "string") {
      ...
      return own10.call(this.namespace, key) && this.namespace[key] || void 0;
    }
    if (key) {
      assertUnfrozen("data", this.frozen);
      this.namespace = key;
...
var se = k2(re2).replace(/bull/g, N2).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex();
var Pe = k2(re2).replace(/bull/g, N2).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex();
var Q2 = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/;
var Se = /^[^\n]+/;
var j2 = /(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/;
var $e2 = k2(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", j2).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex();
var _e = k2(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, N2).getRegex();
var q2 = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul";
var F2 = /<!--(?:-?>|[\s\S]*?(?:-->|$))/;
var Le = k2("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", F2).replace("tag", q2).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex();
var ie = k2(Q2).replace("hr", A2).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", q2).getRegex();
var Me = k2(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph", ie).getRegex();
var U2 = { blockquote: Me, code: Oe, def: $e2, fences: we, heading: ye, hr: A2, html: Le, lheading: se, list: _e, newline: Te, paragraph: ie, table: _, text: Se };
var te = k2("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", A2).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", q2).getRegex();
var ze = { ...U2, lheading: Pe, table: te, paragraph: k2(Q2).replace("hr", A2).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", te).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", q2).getRegex() };
var Ee = { ...U2, html: k2(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment", F2).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(), def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/, heading: /^(#{1,6})(.*)(?:\n+|$)/, fences: _, lheading: /^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/, paragraph: k2(Q2).replace("hr", A2).replace("heading", ` *#{1,6} *[^
...
var K2 = /[\s\p{P}\p{S}]/u;
var ae = /[^\s\p{P}\p{S}]/u;
var Be = k2(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, K2).getRegex();
var le = /(?!~)[\p{P}\p{S}]/u;
var De = /(?!~)[\s\p{P}\p{S}]/u;
var qe = /(?:[^\s\p{P}\p{S}]|~)/u;
var ue = /(?![*_])[\p{P}\p{S}]/u;
...
var Ge = k2(/link|precode-code|html/, "g").replace("link", /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-", Re ? "(?<!`)()" : "(^^|[^`])").replace("code", /(?<b>`+)[^`]+\k<b>(?!`)/).replace("html", /<(?! )[^<>]*?>/).getRegex();
var pe = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/;
var Ze = k2(pe, "u").replace(/punct/g, v2).getRegex();
var Ne = k2(pe, "u").replace(/punct/g, le).getRegex();
var ce = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)";
var Qe = k2(ce, "gu").replace(/notPunctSpace/g, ae).replace(/punctSpace/g, K2).replace(/punct/g, v2).getRegex();
var je = k2(ce, "gu").replace(/notPunctSpace/g, qe).replace(/punctSpace/g, De).replace(/punct/g, le).getRegex();
var Fe = k2("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, ae).replace(/punctSpace/g, K2).replace(/punct/g, v2).getRegex();
var Ue = k2(/^~~?(?:((?!~)punct)|[^\s~])/, "u").replace(/punct/g, ue).getRegex();
var Ke = "^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)";
var We = k2(Ke, "gu").replace(/notPunctSpace/g, He).replace(/punctSpace/g, ve).replace(/punct/g, ue).getRegex();
var Xe = k2(/\\(punct)/, "gu").replace(/punct/g, v2).getRegex();
var Je = k2(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex();
var Ve = k2(F2).replace("(?:-->|$)", "-->").getRegex();
var Ye = k2("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", Ve).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex();
var D2 = /(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/;
var et = k2(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label", D2).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex();
var he = k2(/^!?\[(label)\]\[(ref)\]/).replace("label", D2).replace("ref", j2).getRegex();
var ke = k2(/^!?\[(ref)\](?:\[\])?/).replace("ref", j2).getRegex();
var tt = k2("reflink|nolink(?!\\()", "g").replace("reflink", he).replace("nolink", ke).getRegex();
var ne = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/;
var W2 = { _backpedal: _, anyPunctuation: Xe, autolink: Je, blockSkip: Ge, br: oe, code: Ae, del: _, delLDelim: _, delRDelim: _, emStrongLDelim: Ze, emStrongRDelimAst: Qe, emStrongRDelimUnd: Fe, escape: Ie, link: et, nolink: ke, punctuation: Be, reflink: he, reflinkSearch: tt, tag: Ye, text: Ce, url: _ };
var nt = { ...W2, link: k2(/^!?\[(label)\]\((.*?)\)/).replace("label", D2).getRegex(), reflink: k2(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", D2).getRegex() };
var Z2 = { ...W2, emStrongRDelimAst: je, emStrongLDelim: Ne, delLDelim: Ue, delRDelim: We, url: k2(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol", ne).replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(), _backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/, del: /^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/, text: k2(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol", ne).getRegex() };
var rt = { ...Z2, br: k2(oe).replace("{2,}", "*").getRegex(), text: k2(Z2.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex() };
var C2 = { normal: U2, gfm: ze, pedantic: Ee };
var z2 = { normal: W2, gfm: Z2, breaks: rt, pedantic: nt };
var st = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" };
var de = (u4) => st[u4];
function O2(u4, e) {
  if (e) {
...
var w2 = class {
  ...
  code(e) {
    ...
    if (t) {
      ...
      return { type: "code", raw: t[0], codeBlockStyle: "indented", text: this.options.pedantic ? n : E2(n, `
`) };
    }
  }
  fences(e) {
  ...
  hr(e) {
    ...
    if (t) return { type: "hr", raw: E2(t[0], `
`) };
  }
  blockquote(e) {
...
`, e = e.substring(h3.length + 1), l = true), !l) {
          let S2 = this.rules.other.nextBulletRegex(f2), V2 = this.rules.other.hrRegex(f2), Y2 = this.rules.other.fencesBeginRegex(f2), ee = this.rules.other.headingBeginRegex(f2), xe = this.rules.other.htmlBeginRegex(f2), be2 = this.rules.other.blockquoteBeginRegex(f2);
          for (; e; ) {
            let H2 = e.split(`
`, 1)[0], I2;
            if (h3 = H2, this.options.pedantic ? (h3 = h3.replace(this.rules.other.listReplaceNesting, "  "), I2 = h3) : I2 = h3.replace(this.rules.other.tabCharGlobal, "    "), Y2.test(h3) || ee.test(h3) || xe.test(h3) || be2.test(h3) || S2.test(h3) || V2.test(h3)) break;
            if (I2.search(this.rules.other.nonSpaceChar) >= f2 || !h3.trim()) c2 += `
` + I2.slice(f2);
            else {
              if (R3 || d2.replace(this.rules.other.tabCharGlobal, "    ").search(this.rules.other.nonSpaceChar) >= 4 || Y2.test(d2) || ee.test(d2) || V2.test(d2)) break;
              c2 += `
` + h3;
            }
            R3 = !h3.trim(), p2 += H2 + `
`, e = e.substring(H2.length + 1), d2 = I2.slice(f2);
          }
        }
  ...
  table(e) {
    ...
    let n = J2(t[1]), r = t[2].replace(this.rules.other.tableAlignChars, "").split("|"), i = t[3]?.trim() ? t[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], s2 = { type: "table", raw: t[0], header: [], align: [], rows: [] };
    if (n.length === r.length) {
      ...
      for (let a of i) s2.rows.push(J2(a, s2.header.length).map((o, l) => ({ text: o, tokens: this.lexer.inline(o), header: false, align: s2.align[l] })));
      return s2;
    }
  }
  lheading(e) {
...
var x2 = class u2 {
  ...
  tokenizer;
  constructor(e) {
    this.tokens = [], this.tokens.links = /* @__PURE__ */ Object.create(null), this.options = e || T2, this.options.tokenizer = this.options.tokenizer || new w2(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = { inLink: false, inRawBlock: false, top: true };
    let t = { other: m2, block: C2.normal, inline: z2.normal };
    this.options.pedantic ? (t.block = C2.pedantic, t.inline = z2.pedantic) : this.options.gfm && (t.block = C2.gfm, this.options.breaks ? t.inline = z2.breaks : t.inline = z2.gfm), this.tokenizer.rules = t;
  }
  static get rules() {
    return { block: C2, inline: z2 };
  }
  static lex(e, t) {
...
`;
    return r ? '<pre><code class="language-' + O2(r) + '">' + (n ? i : O2(i, true)) + `</code></pre>
` : "<pre><code>" + (n ? i : O2(i, true)) + `</code></pre>
`;
  }
  blockquote({ tokens: e }) {
    return `<blockquote>
...
`;
  ...
  link({ href: e, title: t, tokens: n }) {
    let r = this.parser.parseInline(n), i = X2(e);
    if (i === null) return r;
    e = i;
    let s2 = '<a href="' + e + '"';
    return t && (s2 += ' title="' + O2(t) + '"'), s2 += ">" + r + "</a>", s2;
  }
  image({ href: e, title: t, text: n, tokens: r }) {
    r && (n = this.parser.parseInline(r, this.parser.textRenderer));
    let i = X2(e);
    if (i === null) return O2(n);
    e = i;
    let s2 = `<img src="${e}" alt="${O2(n)}"`;
    return t && (s2 += ` title="${O2(t)}"`), s2 += ">", s2;
  }
  text(e) {
...
var b2 = class u3 {
  ...
  textRenderer;
  constructor(e) {
    this.options = e || T2, this.options.renderer = this.options.renderer || new y2(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.renderer.parser = this, this.textRenderer = new $3();
  }
  static parse(e, t) {
  ...
  parseMarkdown(e) {
    return (n, r) => {
      ...
      if (s2.hooks && (s2.hooks.options = s2, s2.hooks.block = e), s2.async) return (async () => {
        let o = s2.hooks ? await s2.hooks.preprocess(n) : n, p2 = await (s2.hooks ? await s2.hooks.provideLexer() : e ? x2.lex : x2.lexInline)(o, s2), c2 = s2.hooks ? await s2.hooks.processAllTokens(p2) : p2;
        s2.walkTokens && await Promise.all(this.walkTokens(c2, s2.walkTokens));
        let h3 = await (s2.hooks ? await s2.hooks.provideParser() : e ? b2.parse : b2.parseInline)(c2, s2);
        return s2.hooks ? await s2.hooks.postprocess(h3) : h3;
      })().catch(a);
      try {
        s2.hooks && (n = s2.hooks.preprocess(n));
        let l = (s2.hooks ? s2.hooks.provideLexer() : e ? x2.lex : x2.lexInline)(n, s2);
        s2.hooks && (l = s2.hooks.processAllTokens(l)), s2.walkTokens && this.walkTokens(l, s2.walkTokens);
        let c2 = (s2.hooks ? s2.hooks.provideParser() : e ? b2.parse : b2.parseInline)(l, s2);
...
Please report this to https://github.com/markedjs/marked.`, e) {
        let r = "<p>An error occurred:</p><pre>" + O2(n.message + "", true) + "</pre>";
  ...
  return (0, import_react.useEffect)(() => {
    ...
    let f2 = () => {
      ...
      f2(), i.current = window.setTimeout(() => {
        ...
        (w3.length === 0 || (H2 = (M3 = w3.at(-1)) == null ? void 0 : M3.isIntersecting) != null && H2) && h3(v3);
      }, o);
    }, g3 = (v3, w3) => {
...
var cr = (0, import_react.lazy)(() => import("./highlighted-body-OFNGDK62-MZ7X4LNG.js").then((e) => ({ default: e.HighlightedCodeBlockBody })));
var st2 = ({ code: e, language: t, className: o, children: n, isIncomplete: r = false, startLine: s2, lineNumbers: a, ...l }) => {
...
var we2 = { CheckIcon: jt, CopyIcon: Ft, DownloadIcon: zt, ExternalLinkIcon: Zt, Loader2Icon: _t, Maximize2Icon: qt, RotateCcwIcon: $t, XIcon: Wt2, ZoomInIcon: Xt2, ZoomOutIcon: Jt2 };
...
var Te2 = ({ children: e, className: t, onCopy: o, onError: n, timeout: r = 2e3 }) => {
  let s2 = y3(), [a, l] = (0, import_react.useState)(false), [i, d2] = (0, import_react.useState)(false), c2 = (0, import_react.useRef)(null), p2 = (0, import_react.useRef)(0), { isAnimating: m3 } = (0, import_react.useContext)(R2), u4 = D3(), f2 = async (g3) => {
    ...
    try {
      ...
      let M3 = ue2(P2), F3 = ({ csv: ne2, tsv: dt, md: re3 }[g3] || re3)(M3), j3 = new ClipboardItem({ "text/plain": new Blob([F3], { type: "text/plain" }), "text/html": new Blob([P2.outerHTML], { type: "text/html" }) });
    ...
    try {
      ...
      switch (r) {
        case "csv":
          ...
          break;
        case "markdown":
          b3 = re3(h3), g3 = "text/markdown", T3 = "md";
          break;
        default:
          b3 = ne2(h3), g3 = "text/csv", T3 = "csv";
      }
...
var Pe2 = ({ children: e, className: t, onDownload: o, onError: n }) => {
  let r = y3(), [s2, a] = (0, import_react.useState)(false), l = (0, import_react.useRef)(null), { isAnimating: i } = (0, import_react.useContext)(R2), d2 = D3(), c2 = L3(), p2 = (m3) => {
    ...
    try {
      ...
      let b3 = ue2(h3), g3 = m3 === "csv" ? ne2(b3) : re3(b3);
...
var os = (0, import_react.lazy)(() => import("./mermaid-GHXKKRXX-AD52RSCI.js").then((e) => ({ default: e.Mermaid })));
var ns = /language-([^\s]+)/;
function qe2(e, t) {
...
var ss = ({ node: e, className: t, children: o, ...n }) => {
  ...
  let P2 = ft(l, "code"), M3 = To(l, "download"), H2 = To(l, "copy");
  return (0, import_jsx_runtime.jsx)(st2, { className: t, code: w3, isIncomplete: c2, language: m3, lineNumbers: v3, startLine: g3, children: P2 ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [M3 ? (0, import_jsx_runtime.jsx)(it2, { code: w3, language: m3 }) : null, H2 ? (0, import_jsx_runtime.jsx)(Ae2, {}) : null] }) : null });
};
...
var Qo = [];
var en3 = { allowDangerousHtml: true };
...
var ks = (e) => {
  let t = e.rehypePlugins || Qo, o = e.remarkPlugins || Qo, n = Cs(t) ? o : [...o, Go], r = e.remarkRehypeOptions ? { ...en3, ...e.remarkRehypeOptions } : en3;
...
var Qs = (0, import_react.memo)(({ children: e, mode: t = "streaming", dir: o, parseIncompleteMarkdown: n = true, normalizeHtmlIndentation: r = false, components: s2, rehypePlugins: a = gn2, remarkPlugins: l = Us, className: i, shikiTheme: d2 = vn2, mermaid: c2, controls: p2 = true, isAnimating: m3 = false, animated: u4, BlockComponent: f2 = Tn2, parseMarkdownIntoBlocksFn: h3 = kt, caret: b3, plugins: g3, remend: T3, linkSafety: v3 = xn, lineNumbers: w3 = true, allowedTags: P2, literalTagContent: M3, translations: H2, icons: S2, prefix: F3, onAnimationStart: j3, onAnimationEnd: z3, ...B3 }) => {
  ...
  X3.current = j3, Re2.current = z3, (0, import_react.useEffect)(() => {
    ...
    if (q3.current = m3, k3 === null) {
      m3 && ((A3 = X3.current) == null || A3.call(X3));
      return;
    }
  ...
  let J3 = t === "streaming" ? Ln2 : fe2, Ke2 = (0, import_react.useMemo)(() => o === "auto" ? J3.map($e3) : void 0, [J3, o]), Rn2 = (0, import_react.useMemo)(() => J3.map((k3, A3) => `${_2}-${A3}`), [J3.length, _2]), Ue2 = (0, import_react.useMemo)(() => u4 === true ? "true" : u4 ? JSON.stringify(u4) : "", [u4]), ge2 = (0, import_react.useMemo)(() => Ue2 ? Ue2 === "true" ? be() : be(u4) : null, [Ue2]), Pt = (0, import_react.useMemo)(() => {
    var k3, A3;
    return { shikiTheme: (A3 = (k3 = g3 == null ? void 0 : g3.code) == null ? void 0 : k3.getThemes()) != null ? A3 : d2, controls: p2, isAnimating: m3, lineNumbers: w3, mode: t, mermaid: c2, linkSafety: v3 };
  }, [d2, p2, m3, w3, t, c2, v3, g3 == null ? void 0 : g3.code]), Sn2 = (0, import_react.useMemo)(() => H2 ? JSON.stringify(H2) : "", [H2]), Mt = (0, import_react.useMemo)(() => ({ ...De2, ...H2 }), [Sn2]), It = (0, import_react.useMemo)(() => {
    let { inlineCode: k3, ...A3 } = s2 != null ? s2 : {}, K3 = { ...Ko, ...A3 };
    if (k3) {
      let ee = K3.code;
    ...
    if (P2 && Object.keys(P2).length > 0 && a === gn2) {
      let K3 = { ...Ze2, tagNames: [...(A3 = Ze2.tagNames) != null ? A3 : [], ...Object.keys(P2)], attributes: { ...Ze2.attributes, ...P2 } };
  ...
  return t === "static" ? (0, import_jsx_runtime.jsx)(Be2.Provider, { value: Mt, children: (0, import_jsx_runtime.jsx)(Ve2.Provider, { value: g3 != null ? g3 : null, children: (0, import_jsx_runtime.jsx)(R2.Provider, { value: Pt, children: (0, import_jsx_runtime.jsx)(at, { icons: S2, children: (0, import_jsx_runtime.jsx)(Ee2.Provider, { value: x3, children: (0, import_jsx_runtime.jsx)("div", { className: x3("space-y-4 whitespace-normal [&>*:first-child]:mt-0 [&>*:last-child]:mb-0", i), dir: o === "auto" ? $e3(Se2) : o, children: (0, import_jsx_runtime.jsx)(Ct, { components: It, rehypePlugins: Lt, remarkPlugins: Nt, ...B3, children: Se2 }) }) }) }) }) }) }) : (0, import_jsx_runtime.jsx)(Be2.Provider, { value: Mt, children: (0, import_jsx_runtime.jsx)(Ve2.Provider, { value: g3 != null ? g3 : null, children: (0, import_jsx_runtime.jsx)(R2.Provider, { value: Pt, children: (0, import_jsx_runtime.jsx)(at, { icons: S2, children: (0, import_jsx_runtime.jsx)(Ee2.Provider, { value: x3, children: (0, import_jsx_runtime.jsxs)("div", { className: x3("space-y-4 whitespace-normal [&>*:first-child]:mt-0 [&>*:last-child]:mb-0", b3 && !Ge2 ? "[&>*:last-child]:after:inline [&>*:last-child]:after:align-baseline [&>*:last-child]:after:content-[var(--streamdown-caret)]" : null, i), style: En2, children: [J3.length === 0 && b3 && m3 && (0, import_jsx_runtime.jsx)("span", {}), J3.map((k3, A3) => {
    var ie2;
    let K3 = A3 === J3.length - 1, ee = m3 && K3 && ht(k3);
    return (0, import_jsx_runtime.jsx)(f2, { animatePlugin: ge2, components: It, content: k3, dir: (ie2 = Ke2 == null ? void 0 : Ke2[A3]) != null ? ie2 : o !== "auto" ? o : void 0, index: A3, isIncomplete: ee, rehypePlugins: Lt, remarkPlugins: Nt, shouldNormalizeHtmlIndentation: r, shouldParseIncompleteMarkdown: n, ...B3 }, Rn2[A3]);
  })] }) }) }) }) }) });
...
var Nn2 = ({ children: e, className: t, minZoom: o = 0.5, maxZoom: n = 3, zoomStep: r = 0.1, showControls: s2 = true, initialZoom: a = 1, fullscreen: l = false }) => {
  let { RotateCcwIcon: i, ZoomInIcon: d2, ZoomOutIcon: c2 } = L3(), p2 = y3(), m3 = (0, import_react.useRef)(null), u4 = (0, import_react.useRef)(null), [f2, h3] = (0, import_react.useState)(a), [b3, g3] = (0, import_react.useState)({ x: 0, y: 0 }), [T3, v3] = (0, import_react.useState)(false), [w3, P2] = (0, import_react.useState)({ x: 0, y: 0 }), [M3, H2] = (0, import_react.useState)({ x: 0, y: 0 }), S2 = (0, import_react.useCallback)((x3) => {
    ...
    v3(true), P2({ x: x3.clientX, y: x3.clientY }), H2(b3);
...
var po = ({ chart: e, className: t, config: o, fullscreen: n = false, showControls: r = true }) => {
  ...
  if ((0, import_react.useEffect)(() => {
    ...
    (async () => {
      try {
        l(null), d2(true);
        let H2 = g3.getMermaid(o), S2 = e.split("").reduce((z3, B3) => (z3 << 5) - z3 + B3.charCodeAt(0) | 0, 0), F3 = `mermaid-${Math.abs(S2)}-${Date.now()}-${Math.random().toString(36).substring(2, 9)}`, { svg: j3 } = await H2.render(F3, e);
        p2(j3), u4(j3);
      } catch (H2) {
        if (!(m3 || c2)) {
          let S2 = H2 instanceof Error ? H2.message : "Failed to render Mermaid chart";
          l(S2);
        }
      } finally {
        d2(false);
...
//# sourceMappingURL=chunk-W3HUXFNT.js.map
