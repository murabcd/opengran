...
export function NoteComposer({
	...
	}, [fullTranscript, isSpeechListening, onEnhanceTranscript]);
				...
				<div className="absolute inset-x-0 bottom-0 z-20">
					<div className="relative flex items-end gap-3">
						<Card className="relative -mx-6 h-96 max-h-[calc(100dvh-6rem)] w-[calc(100%+3rem)] gap-0 py-0">
							...
							<CardContent className="flex flex-1 overflow-hidden px-4 pb-6">
								{fullTranscript ? (
						...
						<div className="absolute bottom-[13px] left-0 z-10">
							{speechControls}
						</div>
					</div>
				</div>
